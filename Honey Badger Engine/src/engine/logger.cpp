...
void HoneyBadger::Logger::checkFile() {
...
std::string HoneyBadger::Logger::getDateTime() {
...
void HoneyBadger::Logger::writeLog(char* logMsg) {
...
void HoneyBadger::Logger::infoLog(char* infoMsg) {
...
void HoneyBadger::Logger::debugLog(char* dbugMsg) {
...
void HoneyBadger::Logger::warningLog(char* wrngMsg) {
...
void HoneyBadger::Logger::errorLog(char* errMsg) {
