...
bool HoneyBadger::Physics::collisionBox(SDL_Rect colidded, SDL_Rect colidder) {
...
int HoneyBadger::Physics::collisionCircle(int mainPosX, int mainPosY, int clashPosX, int clashPosY) {
