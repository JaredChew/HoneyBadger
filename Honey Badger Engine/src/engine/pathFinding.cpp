...
HoneyBadger::Module::A_Star::A_Star() {
...
void HoneyBadger::Module::A_Star::initPathfinding(std::vector< std::vector<Node> > &node, Node &start, Node &end, A_Star &astr) {
...
bool HoneyBadger::Module::A_Star::moveOnPath(toMove &character, std::vector< std::vector<Node> > node) {
...
void HoneyBadger::Module::A_Star::searchPath(std::vector< std::vector<Node> > &node) {
...
void HoneyBadger::Module::A_Star::resetSearch(std::vector< std::vector<Node> > &node) {
...
void HoneyBadger::Module::A_Star::getDirection() {
...
bool HoneyBadger::Module::A_Star::checkBoundaries(std::vector< std::vector<Node> > node, int currentNodeX, int currentNodeY) {
...
bool HoneyBadger::Module::A_Star::checkDirectionPrioirty(std::vector< std::vector<Node> > &node) {
...
bool HoneyBadger::Module::A_Star::checkDirection(std::vector< std::vector<Node> > &node) {
...
void HoneyBadger::Module::A_Star::setTileSize(int tileSize) {
	this->tileSize = tileSize;
}

void HoneyBadger::Module::A_Star::setNumOfTilesX(int totalTilesX) {
	this->totalTilesX = totalTilesX;
}

void HoneyBadger::Module::A_Star::setNumOfTilesY(int totalTilesY) {
	this->totalTilesY = totalTilesY;
}

void HoneyBadger::Module::A_Star::setNumOfTiles(int totalTilesX, int totalTilesY) {
	this->totalTilesX = totalTilesX;
	this->totalTilesY = totalTilesY;
}

void HoneyBadger::Module::A_Star::setStartNodeX(int startNodeX) {
	this->startNodeX = startNodeX;
}

void HoneyBadger::Module::A_Star::setStartNodeY(int startNodeY) {
	this->startNodeY = startNodeY;
}

void HoneyBadger::Module::A_Star::setStartNodes(int startNodeX, int startNodeY) {
	this->startNodeX = startNodeX;
	this->startNodeY = startNodeY;
}

void HoneyBadger::Module::A_Star::setEndNodeX(int endNodeX) {
	this->endNodeX = endNodeX;
}

void HoneyBadger::Module::A_Star::setEndNodeY(int endNodeY) {
	this->endNodeY = endNodeY;
}

void HoneyBadger::Module::A_Star::setEndNodes(int endNodeX, int endNodeY) {
	this->endNodeX = endNodeX;
	this->endNodeY = endNodeY;
}